...
//        int v; v=4; (while (v>0) print(v);v=v-1);print(v)
        ...
        try {
            TypeChecker.runChecks(stmt1, stmt2, stmt3, stmt4, stmt5, stmt6, stmt7, stmt8, stmt9, stmt10);
        }
        catch (Exception e) {
        ...
        // creating all the program states
        ...
        PrgState myPrgState10 = new PrgState(stmt10);


        // creating all the repos and controllers
        ...
        Repo myRepo9 = new Repo(myPrgState9, "logFile9.out");
        Controller myController9 = new Controller(myRepo9);
        Repo myRepo10 = new Repo(myPrgState10, "logFile10.out");
        Controller myController10 = new Controller(myRepo10);


        // initializing the command menu and adding all the necessary commands
        ...
        menu.addCommand(new RunExample("10", stmt10.toString(), myController10));
