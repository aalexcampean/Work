...
public class PrgState {
    ...
    public PrgState(IStmt stmt) {
        ...
        this.barrierTbl = new MyBarrier();
    }

    public PrgState(IStack<IStmt> eStack, IDictionary<String, IValue> sTable, IList<IValue> o, IStmt orgProgram, IDictionary<StringValue, BufferedReader> fTable, IHeap<IValue> h, IBarrier semTable){
        threadId = getThreadId();
    ...
    // barrier related methods
    public IBarrier getBarrierTbl() {return this.barrierTbl;}
    public void setBarrierTbl(IDictionary<Integer, Pair<Integer, ArrayList<Integer>>> semaphoreTable) { this.barrierTbl.setContent(semaphoreTable);}
