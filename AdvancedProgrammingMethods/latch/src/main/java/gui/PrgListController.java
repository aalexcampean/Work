...
import model.statements.threads.latch.AwaitLatchStmt;
import model.statements.threads.latch.CountDownStmt;
import model.statements.threads.latch.LatchStmt;
                                        ...
                                        new CompStmt(new HeapAllocationStmt("v1", new ValueExp(new IntValue(2))),
                                                new CompStmt(new HeapAllocationStmt("v2", new ValueExp(new IntValue(3))),
                                                        new CompStmt(new HeapAllocationStmt("v3", new ValueExp(new IntValue(4))),
                                                                new CompStmt(new LatchStmt("cnt", new HeapReadingExp(new VarExp("v2"))),
                                                                        new CompStmt(new ForkStmt(new CompStmt(new HeapWritingStmt("v1", new ArithExp('*', new HeapReadingExp(new VarExp("v1")), new ValueExp(new IntValue(10)))),
                                                                                        new CompStmt(new PrintStmt(new HeapReadingExp(new VarExp("v1"))), new CountDownStmt("cnt")))),
                                                                                new CompStmt(new ForkStmt(new CompStmt(new HeapWritingStmt("v2", new ArithExp('*', new HeapReadingExp(new VarExp("v2")), new ValueExp(new IntValue(10)))),
                                                                                        new CompStmt(new PrintStmt(new HeapReadingExp(new VarExp("v2"))), new CountDownStmt("cnt")))),
                                                                                        new CompStmt(new ForkStmt(new CompStmt(new HeapWritingStmt("v3", new ArithExp('*', new HeapReadingExp(new VarExp("v3")), new ValueExp(new IntValue(10)))),
                                                                                                new CompStmt(new PrintStmt(new HeapReadingExp(new VarExp("v3"))), new CountDownStmt("cnt")))),
