...
import model.statements.threads.semaphore.AcquireSemaphoreStmt;
import model.statements.threads.semaphore.ReleaseSemaphoreStmt;
import model.statements.threads.semaphore.CreateSemaphoreStmt;
...
//        //        print(rh(a))
//        IStmt stmt11 = new CompStmt(new VarDeclStmt("a", new RefType(new IntType())),
...
//        IStmt stmt13 = new CompStmt(new VarDeclStmt("v", new IntType()),
//                new CompStmt(new AssignStmt("v", new ValueExp(new IntValue(10))),
...
//                                                                                                    new PrintStmt(new ArithExp('*', new VarExp("v"), new ValueExp(new IntValue(10)))))))))))))));
        ...
        // (default : print(300)));
        // print(300)
        IStmt stmt1 = new CompStmt(new VarDeclStmt("a", new IntType()),
        ...
        // print(rh(v1) - 1);
        // release(cnt)
        IStmt stmt2 = new CompStmt(new VarDeclStmt("v1", new RefType(new IntType())),
                new CompStmt(new VarDeclStmt("cnt", new IntType()),
                        new CompStmt(new HeapAllocationStmt("v1", new ValueExp(new IntValue(1))),
                                new CompStmt(new CreateSemaphoreStmt("cnt", new HeapReadingExp(new VarExp("v1"))),
                                        new CompStmt(new ForkStmt(new CompStmt(new AcquireSemaphoreStmt("cnt"),
                                                new CompStmt(new HeapWritingStmt("v1", new ArithExp('*', new HeapReadingExp(new VarExp("v1")), new ValueExp(new IntValue(10)))),
                                                        new CompStmt(new PrintStmt(new HeapReadingExp(new VarExp("v1"))), new ReleaseSemaphoreStmt("cnt"))))),
                                                new CompStmt(new ForkStmt(new CompStmt(new AcquireSemaphoreStmt("cnt"),
                                                        new CompStmt(new HeapWritingStmt("v1", new ArithExp('*', new HeapReadingExp(new VarExp("v1")), new ValueExp(new IntValue(10)))),
                                                                new CompStmt(new HeapWritingStmt("v1", new ArithExp('*', new HeapReadingExp(new VarExp("v1")), new ValueExp(new IntValue(2)))),
                                                                        new CompStmt(new PrintStmt(new HeapReadingExp(new VarExp("v1"))), new ReleaseSemaphoreStmt("cnt")))))),
                                                        new CompStmt(new AcquireSemaphoreStmt("cnt"),
                                                                new CompStmt(new PrintStmt(new ArithExp('-', new HeapReadingExp(new VarExp("v1")), new ValueExp(new IntValue(1)))),
...
//        ArrayList<IStmt> stmts = new ArrayList<IStmt>(Arrays.asList(stmt1, stmt2, stmt3, stmt3, stmt4, stmt5, stmt6, stmt7, stmt8, stmt9, stmt10, stmt11, stmt12, stmt13, stmt14, stmt15, stmt16));
        ArrayList<IStmt> stmts = new ArrayList<IStmt>(Arrays.asList(stmt1, stmt2));
