...
import model.statements.threads.lock.LockStmt;
import model.statements.threads.lock.UnlockStmt;
import model.statements.threads.lock.NewLockStmt;
...
//        newLock(q);
//        fork(fork(lock(q); wh(v2, rh(v2) + 5); unlock(q));
                                                        ...
                                                        new CompStmt(new NewLockStmt("x"),
                                                                new CompStmt(new ForkStmt(new CompStmt(new ForkStmt(
                                                                        new CompStmt(new LockStmt("x"),
                                                                                new CompStmt(new HeapWritingStmt("v1", new ArithExp('-', new HeapReadingExp(new VarExp("v1")), new ValueExp(new IntValue(1)))), new UnlockStmt("x")))),
                                                                        new CompStmt(new LockStmt("x"),
                                                                                new CompStmt(new HeapWritingStmt("v1", new ArithExp('*', new HeapReadingExp(new VarExp("v1")), new ValueExp(new IntValue(10)))), new UnlockStmt("x"))))),
                                                                        new CompStmt(new NewLockStmt("q"),
                                                                                new CompStmt(new ForkStmt(new CompStmt(new ForkStmt(
                                                                                        new CompStmt(new LockStmt("q"),
                                                                                                new CompStmt(new HeapWritingStmt("v2", new ArithExp('+', new HeapReadingExp(new VarExp("v2")), new ValueExp(new IntValue(5)))), new UnlockStmt("q")))),
                                                                                        new CompStmt(new LockStmt("q"),
                                                                                                new CompStmt(new HeapWritingStmt("v2", new ArithExp('*', new HeapReadingExp(new VarExp("v2")), new ValueExp(new IntValue(10)))), new UnlockStmt("q"))))),
                                                                                                                        ...
                                                                                                                        new CompStmt(new LockStmt("x"),
                                                                                                                                new CompStmt(new PrintStmt(new HeapReadingExp(new VarExp("v1"))),
                                                                                                                                        new CompStmt(new UnlockStmt("x"),
                                                                                                                                                new CompStmt(new LockStmt("q"),
                                                                                                                                                        new CompStmt(new PrintStmt(new HeapReadingExp(new VarExp("v2"))), new UnlockStmt("q"))))))))))))))))))));
