...
public class PrgRunController implements Initializable {
    ...
    // semaphoreTable
    @FXML
    TableView<HashMap.Entry<Integer, MyTriplet<Integer, ArrayList<Integer>, Integer>>> toySemaphoreTable;
    @FXML
    TableColumn<HashMap.Entry<Integer, MyTriplet<Integer, ArrayList<Integer>, Integer>>, String> toySemaphoreTableAddress;
    @FXML
    TableColumn<HashMap.Entry<Integer, MyTriplet<Integer, ArrayList<Integer>, Integer>>, String> toySemaphoreTableValue;
    @FXML
    TableColumn<HashMap.Entry<Integer, MyTriplet<Integer, ArrayList<Integer>, Integer>>, String> toySemaphoreTableArray;
...
//                }
    ...
    public void setToySemaphoreTable() {
        if (myController.getRepo().getPrgList().size() > 0) {
            ObservableList<HashMap.Entry<Integer, MyTriplet<Integer, ArrayList<Integer>, Integer>>> toySemaphoreTableList = FXCollections.observableArrayList();
            ...
            toySemaphoreTableList.addAll(myController.getRepo().getPrgList().get(0).getSemaphoreTbl().getContent().getContent().entrySet());
