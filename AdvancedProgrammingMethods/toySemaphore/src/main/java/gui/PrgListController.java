...
import model.statements.threads.toySmaphore.AcquireSemaphoreStmt;
import model.statements.threads.toySmaphore.ReleaseSemaphoreStmt;
import model.statements.threads.toySmaphore.SemaphoreStmt;
        ...
        IStmt stmt16 = new CompStmt(new VarDeclStmt("v1", new RefType(new IntType())),
                new CompStmt(new VarDeclStmt("cnt", new IntType()),
                        new CompStmt(new HeapAllocationStmt("v1", new ValueExp(new IntValue(2))),
                                new CompStmt(new SemaphoreStmt("cnt", new HeapReadingExp(new VarExp("v1")), new ValueExp(new IntValue(1))),
                                        new CompStmt(new ForkStmt(new CompStmt(new AcquireSemaphoreStmt("cnt"),
                                                new CompStmt(new HeapWritingStmt("v1", new ArithExp('*', new HeapReadingExp(new VarExp("v1")),
                                                        new ValueExp(new IntValue(10)))), new CompStmt(new PrintStmt(new HeapReadingExp(new VarExp("v1"))),
                                                        new ReleaseSemaphoreStmt("cnt"))))),
                                                new CompStmt(new ForkStmt(new CompStmt(new AcquireSemaphoreStmt("cnt"),
                                                        new CompStmt(new HeapWritingStmt("v1", new ArithExp('*', new HeapReadingExp(new VarExp("v1")),
                                                                new ValueExp(new IntValue(10)))), new CompStmt(
                                                                new HeapWritingStmt("v1", new ArithExp('*', new HeapReadingExp(new VarExp("v1")),
                                                ...
                                                new CompStmt(new AcquireSemaphoreStmt("cnt"),
                                                        new CompStmt(new PrintStmt(new ArithExp('-',
                                                                new HeapReadingExp(new VarExp("v1")),
