...
public class PrgState {
    ...
    private ISemaphore semaphoreTbl;
    ...
    public PrgState(IStmt stmt) {
        ...
        this.semaphoreTbl = new MySemaphore();
    }

    public PrgState(IStack<IStmt> eStack, IDictionary<String, IValue> sTable, IList<IValue> o, IStmt orgProgram, IDictionary<StringValue, BufferedReader> fTable, IHeap<IValue> h, ISemaphore semTable){
        threadId = getThreadId();
    ...
    public ISemaphore getSemaphoreTbl() {return this.semaphoreTbl;}
    public void setSemaphoreTbl(IDictionary<Integer, MyTriplet<Integer, ArrayList<Integer>, Integer>> semaphoreTable) { this.semaphoreTbl.setContent(semaphoreTable);}
