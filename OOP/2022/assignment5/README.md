...
## Requirements
- Create a graphical userButton interface using the Qt framework for the problem you have been working on (A5-6, A8-9).
...
-	The functionality of the application must be the same (including the one-by-one iteration of objects for the userButton mode).
...
<img width="704" alt="Screenshot 2021-04-17 at 20 24 04" src="https://userButton-images.githubusercontent.com/25611695/115121335-df0f7e00-9fba-11eb-8839-40cd55da1d69.png">
