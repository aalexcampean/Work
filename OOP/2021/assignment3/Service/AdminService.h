#pragma once
#include "../Repository/AdminRepo.h"
...
public:
    ...
    int getAdminServiceLength() const;
    int getAdminServiceCapacity() const;
    ...
    void addElementAdminService(const std::string &title, const std::string &genre, int year_of_release, int nr_of_likes, const std::string &trailer);
    ...
    void deleteElementAdminService(const std::string &title);
    ...
    void updateElementAdminService(const std::string &title, const std::string &genre, int year_of_release, int nr_of_likes, const std::string &trailer);
