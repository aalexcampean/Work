...
class Ui:
    ...
    def display_all_books(self):
        gnome_sort_list(self._book_service.books, lambda a, b: a.id >= b.id)
        print('\n')
    ...
    def display_all_clients(self):
        gnome_sort_list(self._client_service.clients, lambda a, b: a.id >= b.id)
        print('\n')
    ...
    def display_all_rentals(self):
        gnome_sort_list(self._rental_service.rentals, lambda a, b: a.rental_id >= b.rental_id)
        print('\n')
