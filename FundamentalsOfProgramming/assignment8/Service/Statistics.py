...
class Statistics:
    ...
    def create_most_rented_books_statistic(self, list_of_rented_books):
        ...
        return gnome_sort_list(list_of_rented_books, lambda a, b: a['number of rentals'] <= b['number of rentals'])
    ...
    def create_most_active_clients_statistic(self, list_of_active_clients):
        ...
        return gnome_sort_list(list_of_active_clients, lambda a, b: a['number of rented days'] <= b['number of rented days'])
    ...
    def find_the_most_rented_author(self, list_of_rented_authors):
        ...
        return filter_list(list_of_rented_authors, lambda a: a['number of rentals'] == the_max)
    ...
    def create_most_rented_authors_statistic(self, list_of_rented_authors):
        ...
        return self.find_the_most_rented_author(list_of_rented_authors)
