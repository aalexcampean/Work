...
public class DirectCallback
{
    private static List<string> HOSTS;
        ...
        private static void OnConnect(IAsyncResult ar)
        {
            ...
            var byteData = Encoding.ASCII.GetBytes(HTTPUtilities.getRequestString(state.hostname, state.endpointPath));
        ...
        private static void OnReceive(IAsyncResult ar)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    var contentLengthHeaderValue = HTTPUtilities.getContentLength(state.responseContent.ToString());
