...
class userInterface:
    ...
    def printMenu(self):
        ...
        print('|    11. Find if a vertex exists' + '22. Find smallest cost walk'.rjust(53) + '|'.rjust(4))
        print('|    23. Find if the highest cost path if a DAG' + '|'.rjust(42))
        print('-----------------------------------------------------------------------------------------')
        print('|' + '0. Exit'.rjust(43) + '|'.rjust(45))
        print('-----------------------------------------------------------------------------------------\n')
            ...
            try:
                ...
                if option == 1:
                    ...
                    if len(edge) != 2:
                        ...
                        source_vertex = int(edge[0])
                        target_vertex = int(edge[1])
                        path = self._main_graph.findMinimumCostWalk(source_vertex, target_vertex)

                        print(
                                '-----------------------------------------------------------------------------------------')
                        print(
                                f"|    The shortest path between ({source_vertex} {target_vertex}) is: {path[1]} of cost {path[0]}")
                        print(
                                '-----------------------------------------------------------------------------------------')
                    ...
                    if len(edge) != 2:
                        ...
                        source_vertex = int(edge[0])
                        target_vertex = int(edge[1])
                        path = self._main_graph.findHighestCostPath(source_vertex, target_vertex)
                        print(
                            '-----------------------------------------------------------------------------------------')
                        print(
                            f"|    The highest cost path between ({source_vertex} {target_vertex}) is: {path[1]} of cost {path[0]}")
                        print(
                            '-----------------------------------------------------------------------------------------')
