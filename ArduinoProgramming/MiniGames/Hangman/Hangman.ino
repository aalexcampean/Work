...
const char* words[] = {"character", "intelligent", "earth", "astronaut", "cage", "dresser", "leather", "sunflower", "picture", "cheesecake"};
...
void draw_hangman(int var) {
  ...
  switch (var) {
    case 1:
      ...
      break;
    case 2:
      lcd.createChar(1, topbody);         // body top part
      lcd.createChar(3, bottombody);      // body bottom part
      break;
    case 3:
