...
export class AppointmentService {
  ...
  getAllPaginatedAppointments(pageNumber: number, pageSize: number): Observable<AppointmentsDTO> {
    return this.http.get<AppointmentsDTO>(`${(this.baseURL)}/pageNumber=${pageNumber - 1}&pageSize=${pageSize}`, {headers: this.headers})
      .pipe(catchError(this.handleError<AppointmentsDTO>('getAllPaginatedAppointments')));
  }
