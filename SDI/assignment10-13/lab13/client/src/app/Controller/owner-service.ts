...
export class OwnerService {
  ...
  getAllPaginatedOwners(pageNumber: number, pageSize: number): Observable<OwnersDTO> {
    return this.http.get<OwnersDTO>(`${(this.baseURL)}/pageNumber=${pageNumber - 1}&pageSize=${pageSize}`, {headers: this.headers})
      .pipe(catchError(this.handleError<OwnersDTO>('getAllPaginatedOwners')));
  }
